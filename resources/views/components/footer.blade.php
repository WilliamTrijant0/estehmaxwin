<footer class="site-footer">
    ...
    <div class="site-footer__ripped-paper" style="background-image: url(images/shapes/site-footer-ripped-paper.png);"></div>
    <div class="container">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="footer-widget__column footer-widget__about">
                        ...
                        <div class="footer-widget__about-text-box">
                            <p class="footer-widget__about-text">Welcome to our Organic Store. We sell organic foods, fruits & vegetables.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <p class="site-footer__bottom-text">© All Copyright {{ date('Y') }} by <a href="#">Ogenix</a></p>
                    </div>
                </div>
            </div>
        </div>
